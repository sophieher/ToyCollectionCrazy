...
import com.soph1her.toycollectioncrazyscarygirledition.deviceinfoendpoint.Deviceinfoendpoint;
import com.soph1her.toycollectioncrazyscarygirledition.deviceinfoendpoint.model.DeviceInfo;
...
public class GCMIntentService extends GCMBaseIntentService {
   ...
   * information.
   */
  protected static final String PROJECT_NUMBER = "1082565027983";
...
//              + "2) Registration with Endpoints Server...FAILED!\n\n"
              "ec-2. Unable to register your device with your Cloud Endpoints server. Please try again.",
          true, true);
      return;
    }
...
//            + " succeeded!\n\n"
//            + "
        "You are set up to receive update notifications."
//            + getWebSampleUrl(endpoint.getRootUrl())
            , false, true);
  }
  ...
  protected void onUnregistered(Context context, String registrationId) {
    ...
    if (registrationId != null && registrationId.length() > 0) {
      ...
      try {
        ...
        Log.e(GCMIntentService.class.getName(),
            "Exception received when attempting to unregister.", e);
        sendNotificationIntent(
            context,
            "We were unable to de-register your device. Please try again later.",
            true, true);
        return;
      }
    }
    ...
    sendNotificationIntent(
        context,
        "Device de-registration successful!", false, true);
  }
